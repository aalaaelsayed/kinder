...
<html lang="en">
	...
	<body>
		<div class="container">
			<form class="m-auto" style="max-width:600px" action="{{ route('insert') }}" method="post" enctype="multipart/form-data" >
			@csrf
				...
				<div class="form-group mb-3 row"><label for="title2" class="col-md-5 col-form-label">Name</label>
					<div class="col-md-7"><input type="text" class="form-control form-control-lg" id="title2" name="clientName" required value="{{old ('clientName')}}"></div>
					@error('clientName')
          {{ $message}}
      @enderror
				</div>
				...
				<div class="form-group mb-3 row"><label for="content4" class="col-md-5 col-form-label">Content</label>
					<div class="col-md-7"><textarea class="form-control form-control-lg" id="content4" name="content" required value="{{old ('content')}}"></textarea></div>
				</div>
				<hr class="my-4" />
				<div>
